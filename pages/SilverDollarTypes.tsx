...
import Dollar from '/public/Dollar poster.png';
import silverDollarCollectionBg from '/public/CA-Silver Fishes 24012025.png';
import authBackground from '/authbg.jpg';

interface SilverDollarType {
  id: string;
  name: string;
  image: string;
  searchTerm: string;
...
const silverDollarTypes: SilverDollarType[] = [
  {
    id: 'Dollar',
    name: 'Dollar',
    image: Dollar,
...
const SilverDollarTypes: React.FC = () => {
  const navigate = useNavigate();
  
  const handleCardClick = (type: SilverDollarType) => {
    navigate(`/products`, {
      state: { 
        initialCategory: 'Silver Dollar',
      ...
      <div className="min-h-screen flex flex-col bg-transparent">
        ...
        <div className="relative z-10 w-full px-4">
          <div 
            ...
            style={{
              backgroundImage: `url(${silverDollarCollectionBg})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center',
            }}
          >
            ...
            <div className="container mx-auto text-center relative z-10">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Silver Dollar Collection</h1>
              <p className="max-w-2xl mx-auto text-aqua-100">
                Explore our premium selection of exotic silver dollar species
              </p>
            </div>
          </div>
        </div>
...
export default SilverDollarTypes;
